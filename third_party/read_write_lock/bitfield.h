...
#ifndef IPVCORE_THIRD_PARTY_READ_WRITE_LOCK_BITFIELD_H_
#define IPVCORE_THIRD_PARTY_READ_WRITE_LOCK_BITFIELD_H_
...
#endif // IPVCORE_THIRD_PARTY_READ_WRITE_LOCK_BITFIELD_H_
